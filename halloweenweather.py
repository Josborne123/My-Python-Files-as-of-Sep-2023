# The Github version no longer works as customtkinter has since updated
# I have modified this version so that it runs however, it does not look or work the exact same
...
def setup():
    ...
    info_label = customtkinter.CTkLabel(window, text="Find the weather on Halloween for any location, from 1973 onwards", font=("Comic Sans MS bold", 13), text_color="white", bg_color="#f2993f")
